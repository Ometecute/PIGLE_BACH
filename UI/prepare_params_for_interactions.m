...
%% dipole dipole Tippings model

% mu0=3;
% n0 = 1*1/unitcell_area; alpha = 20;
% [fparam4] = dipole_dipole_repulsion.topping_work_function(mu0,n0,sum(number_density),alpha);
%% dipole dipole
% mu0=3 ;
% n0= 1 * 1/unitcell_area; alpha=20;
...
%% H & CO
% % mass1
% mu0=3 ; n0= 1 * 1/unitcell_area; alpha=55;
% mu_eff=dipole_dipole_repulsion.effective_dipole_moment(mu0,alpha,n0,sum(number_density));
% [fparam1, ~] = dipole_dipole_repulsion.f_Kohn_Lau(mu_eff,1);
% 
% %mass28
% mu0=6 ; n0=1 * 1/unitcell_area; alpha=114;
% mu_eff=dipole_dipole_repulsion.effective_dipole_moment(mu0,alpha,n0,sum(number_density));
