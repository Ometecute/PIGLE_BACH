...
nx=120;
ny=200;
ntheta=25; % to request 30 theta vals., starting at 0, e.g., set ntheta=31
...
[V3Dnew, xyposnew, weightnew, npnew, nscalenew] = halvespacing(V3Dinterp, xypos, weight, np,nscale,a,14);
