...
classdef SEexpTools
    ...
    methods(Static)
        ...
        function [lambda_i_Mat, lambda_f_Mat,wavelengthIntMat, tilt] = calcMeasurementsParams(E0, FWHM, max_dEexchange, theta_i, theta_tot)
            ...
            %lambda_i_tmp = linspace(energy2wavelength(1e8,3),energy2wavelength(1e-5,3),numOfPoints);
            ...
            modeModelHandle = SEexpTools.phononModel('RayleighWaveNi111');
...
%             plot(reshape(dK_Mat,1,[]),reshape(modeDE_NiMagnons,1,[]),'b.',reshape(dK_Mat,1,[]),-reshape(modeDE_NiMagnons,1,[]),'b.','MarkerSize',2)
            ...
            featureNum = inputdlg('how many feature there are?'); featureNum = str2num(featureNum{:});
